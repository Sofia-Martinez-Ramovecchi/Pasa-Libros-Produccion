...
<?php echo $__env->make('mapa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!--Vista Perfil -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="publicarLibroForm2" enctype="multipart/form-data" method="POST" action="<?php echo e(route('perfil.mostrar')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo app('Illuminate\Foundation\Vite')([ 'resources/js/publicarLibro.js']); ?>
...
<?php /**PATH /var/www/html/resources/views/modales.blade.php ENDPATH**/ ?>