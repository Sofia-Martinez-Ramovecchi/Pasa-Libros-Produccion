...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewProfile', Auth::user())): ?>
...
<div class="container-xl" id="Division">
    ...
    <!-- Contenido del perfil -->
        ...
        <div class="container-fluid text-center" id="DivFoto">
            ...
            <img src="<?php echo e(Storage::url(Auth::user()->profile_photo)); ?>" alt="Foto de perfil" class="img-fluid rounded-circle perfil-img">


    </div>

    <div id="descripcion" class="col text-center">
        <h1 class="profile-name"><?php echo e(Auth::user()->nombre_usuario); ?></h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="delete-account-form" method="POST" action="<?php echo e(route('perfil.destroy')); ?>">
                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="EditarForm" method="POST" enctype="multipart/form-data" action="<?php echo e(route('perfil.patch')); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
                    <!-- Nombre de Usuario -->
                    <div class="mb-3">
                        <label for="nombre_usuario" class="form-label">Nombre de usuario</label>
                        <input type="text" class="form-control" id="nombre_usuario" name="nombre_usuario" placeholder="Nombre de usuario (opcional)" value="<?php echo e(old('nombre_usuario', auth()->user()->nombre_usuario)); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="Email (opcional)" autocomplete="email" value="<?php echo e(old('email', auth()->user()->email)); ?>">
                ...
                <?php if(session('debug')): ?>
                    <div class="alert alert-info">
                        <ul>
                            <?php $__currentLoopData = session('debug'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $debug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><?php echo e($debug); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                <?php endif; ?>
...
<?php echo app('Illuminate\Foundation\Vite')(['resources/css/EstiloPerfil.css', 'resources/js/form.js']); ?>
</body>
