    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <button type="button" class="btn btn-outline-light me-2" onclick="window.location='{{ route('login') }}'">Iniciar Sesión</button>
                <button type="button" class="btn btn-light" onclick="window.location='{{ route('register') }}'">Registrarse</button>
            </div>
        </div>
    </nav>
